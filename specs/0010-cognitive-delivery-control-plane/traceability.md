...
| R-CDCP-007 | owner_role: learning.dream-orchestrator; owner_role_pending_graduation: learning.skill-curator | `.agents/skills/run-weekly-brief/SKILL.md` v0.1.0 | front-matter parses against `skill.schema.json`; future `validate_skills.py` lands when the second skill graduates |
