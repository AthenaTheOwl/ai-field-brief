...
| R-SRC-020 owner_role: product.source-curator | `sources/registry.yaml` (`frontier-scout` lane); `sources/scout-radar.md`; `prompts/lenses/source_arbitrage.md`; `prompts/lenses/repo_project_scan.md`; `prompts/lenses/action_packet.md`; `templates/weekly-brief.md` | `DEC-SRC-021-frontier-scout-lane-for-early-actionable-sources` | `scripts/validate_registry.py` exits 0; brief template exposes Action packets + Scout radar |
| R-SRC-021 owner_role: product.source-curator | `sources/registry.yaml` (`version: 14`; eight added entries across `vendor-changelog`, `blog`, `youtube-channel`, `academic-paper-series`, `academic-project`, and `standards-docs` types) | `DEC-SRC-022-registry-v14-changelog-and-practitioner-sources` | `scripts/validate_registry.py` exits 0 at 222 active sources; `briefs/2026-W35/meta.yaml` and `briefs/2026-W36/meta.yaml` record per-source disposition and failures |
