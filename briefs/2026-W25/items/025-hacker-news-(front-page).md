...
**Mechanism:** Removes the manual OAuth setup step that currently blocks org-wide MCP rollout; enterprise IT can provision MCP server credentials centrally rather than per-user device flow.
