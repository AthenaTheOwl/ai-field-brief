...
**Mechanism:** Empirical test of three council structures (blending, peer-review, direct selection) on 8 strategy + 8 writing prompts; atomic 'idea cards' blind-rated by judges; councils systematically lose minority good ideas instead of aggregating the best from each model.
