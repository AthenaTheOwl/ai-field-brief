...
**Gist:** Anjney Midha argues frontier labs operate at sub-10% MFU (xAI) vs Google's historical 95% node-utilization baseline, and pitches AMP as horizontal compute pooling so 'FLOPs flow like megawatts'.
...
**Related thread:** compute economics
