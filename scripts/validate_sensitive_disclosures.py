...
SKIP_DIRS = {
    ...
    ".hg",
    ".mypy_cache",
    ".next",  # mirror addition: Next.js build artifact, gitignored elsewhere
    ".pytest_cache",
    ".ruff_cache",
    ".tox",
    ".turbo",  # mirror addition: Turborepo cache
    ".venv",
    "__pycache__",
    "build",
    "dist",
...
ALLOWLIST = {
    ...
    # Per-repo allowlist: prose discussion of database "keys" / "tail" trips
    # the secret-fingerprint-disclosure regex even though no secret is named.
    # Tracked: tighten the source regex in mcp-security-lab to require
    # secret-shaped content proximity, then drop this allowlist entry.
    Path("decisions/DEC-FND-012-workspace-settings-jsonb-not-typed-columns.md"),
}
