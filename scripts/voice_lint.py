#!/usr/bin/env python3
"""Voice lint for ai-field-brief public-facing copy.
...
# Globs that don't yet match any files are silently no-ops (lint stays green
# during early phases and tightens as code lands).
TARGETS = [
    "README.md",
    "NOTICE",
    "CHANGELOG.md",
